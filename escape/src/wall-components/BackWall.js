...
const BackWall = ({
  ...
  const handleSwitchClick = useCallback((e) => {
    ...
    triggerVibration(30);
  }, [playSound, setIsFlickering, setLightsOn, showComment, incrementItemClicks, triggerVibration]);
  ...
  /** DOOR */
  const handleDoorClick = useCallback((e) => {
    e.stopPropagation();
  ...
  /** GRAFFITI */
  const handleChalkClick = useCallback((e) => {
    e.stopPropagation();
  ...
  // ---------------------------------------------------------------------------
  return (
    <div className={`wall wall-back ${isActive ? "active" : ""}`}>
      <div
        ...
        aria-controls="code-input"
        onClick={handleLockClick}
        onKeyDown={onKeyActivate(handleLockClick)}
        tabIndex={0}
        role="button"
      />

      {/* decorative inner door panel */}
      <div className="flat door inner" aria-hidden="true" />
      ...
      <div
        ...
        onKeyDown={onKeyActivate(handleDoorClick)}
        tabIndex={0}
        role="button"
      >
      ...
      <div
        ...
        onKeyDown={onKeyActivate(handleSwitchClick)}
        tabIndex={0}
        role="button"
      >
