...
const Shelf = ({incrementItemClicks,playSound, triggerVibration,showComment, unlockEasterEgg }) => {
  const handleItemClick = (id, sound, comment, options = {}, eggId = null) => {
    ...
    <div className="cube shelf">
      <div className="cube shelf-level level-1">
        ...
        <div
          ...
          onClick={(e) =>
            handleItemClick("cassette", Cassette, e.currentTarget.dataset.comment, { duration: 2 })
          }
        >
      ...
      <div className="cube shelf-level level-2">
        ...
        <div
          ...
          onClick={(e) =>
            handleItemClick("phone", Phone, e.currentTarget.dataset.comment, { duration: 4.2 })
          }
        >
          <div className="item-inner item">
      ...
      <div className="cube shelf-level level-3">
        <div
         ...
         onClick={(e) =>
          handleItemClick("first-aid", FirstAid, e.currentTarget.dataset.comment, { duration: 6 })
        }
        >
